...
part of 'appointment_store_state.dart';
...
/// @nodoc
mixin _$AppointmentStoreState<T> {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppointmentStoreState<T>);
}
...
@override
String toString() {
  return 'AppointmentStoreState<$T>()';
}
...
/// @nodoc
class $AppointmentStoreStateCopyWith<T,$Res>  {
$AppointmentStoreStateCopyWith(AppointmentStoreState<T> _, $Res Function(AppointmentStoreState<T>) __);
}


/// Adds pattern-matching-related methods to [AppointmentStoreState].
extension AppointmentStoreStatePatterns<T> on AppointmentStoreState<T> {
...
class _Initial<T> implements AppointmentStoreState<T> {
  const _Initial();
...
@override
String toString() {
  return 'AppointmentStoreState<$T>.initial()';
}
...
class Loading<T> implements AppointmentStoreState<T> {
  const Loading();
...
@override
String toString() {
  return 'AppointmentStoreState<$T>.loading()';
}
...
class Success<T> implements AppointmentStoreState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of AppointmentStoreState
...
@override
String toString() {
  return 'AppointmentStoreState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AppointmentStoreStateCopyWith<T, $Res> {
...
class Error<T> implements AppointmentStoreState<T> {
...
@override
String toString() {
  return 'AppointmentStoreState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $AppointmentStoreStateCopyWith<T, $Res> {
