...
class Loading<T> implements UpdateProfileState<T> {
  const Loading();
...
class Success<T> implements UpdateProfileState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $UpdateProfileStateCopyWith<T, $Res> {
...
class Error<T> implements UpdateProfileState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $UpdateProfileStateCopyWith<T, $Res> {
