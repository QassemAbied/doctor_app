...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Success<T> value)?  success,TResult Function( Failuer<T> value)?  failure,required TResult orElse(),}){
final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that);case Failuer() when failure != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Success<T> value)  success,required TResult Function( Failuer<T> value)  failure,}){
final _that = this;
switch (_that) {
case Success():
return success(_that);case Failuer():
return failure(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Success<T> value)?  success,TResult? Function( Failuer<T> value)?  failure,}){
final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that);case Failuer() when failure != null:
...
switch (_that) {
case Success() when success != null:
return success(_that.data);case Failuer() when failure != null:
...
switch (_that) {
case Success():
return success(_that.data);case Failuer():
return failure(_that.errorHandler);case _:
  throw StateError('Unexpected subclass');
...
class Failuer<T> with DiagnosticableTreeMixin implements ApiResult<T> {
  const Failuer(this.errorHandler);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FailuerCopyWith<T, Failuer<T>> get copyWith => _$FailuerCopyWithImpl<T, Failuer<T>>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Failuer<T>&&(identical(other.errorHandler, errorHandler) || other.errorHandler == errorHandler));
}
...
/// @nodoc
abstract mixin class $FailuerCopyWith<T,$Res> implements $ApiResultCopyWith<T, $Res> {
  factory $FailuerCopyWith(Failuer<T> value, $Res Function(Failuer<T>) _then) = _$FailuerCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$FailuerCopyWithImpl<T,$Res>
    implements $FailuerCopyWith<T, $Res> {
  _$FailuerCopyWithImpl(this._self, this._then);

  final Failuer<T> _self;
  final $Res Function(Failuer<T>) _then;

/// Create a copy of ApiResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? errorHandler = null,}) {
  return _then(Failuer<T>(
